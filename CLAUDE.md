...
[`jay-withers/renovate`](https://github.com/jay-withers/renovate)
(`github>jay-withers/renovate`) rather than configuring Renovate
...
in `renovate` itself so every consuming repo picks it up; only touch
